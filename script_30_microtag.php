...
$filesToChange = [
    "carboma_cube_1930_710_bxcp_13.html",
    "carboma_bxcb_13d_tehno.html",
...
function changeNameCityAndHeaderFooter($fileWhichChange)
{
    ...
    $content = str_replace(
        ...
        '<div class="product_page_box" itemscope itemtype="https://schema.org/Product">',
        $content);
    ...
    $content = askarFunction667($content, '<ul id="image-gallery"', '</ul>', '<img src', '<img itemprop="image" src');

    $content = str_replace(
        '<span class="__price"><!-- /themes/js/smart-search.js/4027 --></span>',
        '<span itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                        <meta itemprop="priceCurrency" content="KZT">
                        <span class="__price" itemprop="price" content=""><!-- /themes/js/smart-search.js/4027 --></span>
                    </span>',
        $content);

    $content = askarFunction667($content, '<div class="product_character_min mobile_hidden">', '</ul>', '<li>', '<li itemprop="additionalProperty" itemscope itemtype="https://schema.org/PropertyValue">');
    $content = askarFunction667($content, '<div class="product_character_min mobile_hidden">', '</ul>', '</span><span>', '</span><span itemprop="value">');
    $content = askarFunction667($content, '<div class="product_character_min mobile_hidden">', '</ul>', '<span>', '<span itemprop="name">');
